...
class ObjectTracker:
    def __init__(self):
        self.tracker = StrongSort(
            ...
            reid_weights=Path("D:/PPE Detection/osnet_x0_25_msmt17.pt"),
            device="cpu",
            half=False
        )
...
if __name__ == "__main__":
    app = Main_App(Video_path="5.mp4", Model_path="D://Testing_Models//FocalLoss//best.pt",QueueSize=5)  # Initialize app with file paths
